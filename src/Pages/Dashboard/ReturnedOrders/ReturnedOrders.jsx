          ...
          <>
            <div className="container Managers-table-container vh-100">
              ...
              <div className="row Managers-table-row">
                ...
                <div className="col-xl-4 mt-5">
                  <h1 className="Managers-title text-end">الطلبات المرتجعة</h1>{" "}
                  {/* عنوان مناسب */}
                </div>
              </div>
              <div className="row Managers-table-row">
                  ...
                  <table className="table Managers-table table-hover shadow">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th scope="col">تاريخ الارجاع</th> {/* مثال لعمود */}
                          ...
                          {currentItems.map((order, index) => (
                            ...
                            >
                              <td className="actions">
                                <Link
                                  to={`/dashboard/returned-order-details/${order.id}`} // رابط مناسب
                              ...
                              <td>{order.return_date || "غير محدد"}</td>{" "}
