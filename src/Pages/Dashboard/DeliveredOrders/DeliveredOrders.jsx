    ...
    <>
      <section>
        {loading ? (
          ...
          <>
            <div className="container Managers-table-container vh-100"> {/* استخدم نفس الـ Class */}
              <div className="row Managers-table-row">
                ...
                <div className="col-xl-4 mt-5">
                  <h1 className="Managers-title text-end">الطلبات المسلمة</h1> {/* عنوان مناسب */}
                </div>
              </div>
              <div className="row Managers-table-row">
                <div className="col-12 Managers-table-col mt-5">
                  <table className="table Managers-table table-hover shadow"> {/* استخدم نفس الـ Classes */}
                    <thead>
                      <tr>
                        <th scope="col">الاجراءات</th>
                        <th scope="col">معلومات الطلب</th> {/* مثال لعمود */}
